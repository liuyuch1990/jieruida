...
Page({
  ...
  upImg: function() {
    ...
    wx.chooseImage({
      ...
      success: function(res) {
        ...
        if (imgLength > 0) {
          wx.uploadFile({
            url: 'https://www.jieruida-qd.com/distribution/upload', //仅为示例，非真实的接口地址
            ...
            success: function(res) {
              ...
              var name = imgurl.replace('https://www.jieruida-qd.com/imgs/', '').split('.')[0]
  ...
  btnEditClassNameConfirm: function() {
    ...
    util.request(api.updateAppForPic, {
      ...
      url: 'https://www.jieruida-qd.com/dist/index.html#/1pageEdit?id=&name=' + encodeURIComponent(this.data.editClassName),
      type: '1',
