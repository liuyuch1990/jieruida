const ApiRootUrl = 'https://www.jieruida-qd.com/sys/log/queryAll';
// const ApiRootUrl = 'http://118.25.7.94:8360';
const ApiRoot = 'https://www.jieruida-qd.com/';
module.exports = {
  IndexUrl: ApiRootUrl, //首页数据接口
  weixinPay: 'https://www.jieruida-qd.com/api/wxpay/prepayApp',
  ...
  OrderByUserAndActivity: 'https://www.jieruida-qd.com/api/order/getOrderByUserIdAndActivityType',
  ...
  OrderList: 'https://www.jieruida-qd.com/api/' + 'order/getOrderByActivityId',  //订单列表
  gatherOrderList: 'https://www.jieruida-qd.com/gather/queryLike',  //订单列表
  lotteryOrderList: 'https://www.jieruida-qd.com/lottery/queryLotteryLogById',  //订单列表
  distributionList: 'https://www.jieruida-qd.com/' + 'distribution/queryAll',  //分销列表
  gatherList: 'https://www.jieruida-qd.com/' + 'gather/queryAll',  //分销列表
  barginList: 'https://www.jieruida-qd.com/' + 'bargin/queryAll',  //分销列表
  grouponList: 'https://www.jieruida-qd.com/' + 'groupon/queryAll',
  lotteryList: 'https://www.jieruida-qd.com/' + 'lottery/queryAll',
  querybusiness: 'https://www.jieruida-qd.com/sys/log/listByPage',
  querydistribution: 'https://www.jieruida-qd.com/distribution/listByPage',
